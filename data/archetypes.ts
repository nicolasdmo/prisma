...
export const ARCHETYPES: Record<string, Archetype> = {
  ...
  ESVF: {
    ...
    rarity: 7,
    workStyle: 'Rendís mejor cuando el trabajo es dinámico, social y te da libertad de expresión. La monotonía te va apagando sin que te des cuenta.',
    teamRole: 'Sos el que eleva el ánimo cuando las cosas se ponen pesadas. Tu energía es un activo colectivo real.',
    underPressure: 'Podés buscar algo más entretenido en lugar de resolver el conflicto. La disciplina sostenida es tu tarea pendiente.',
  ...
  ENVF: {
    ...
    rarity: 8,
    workStyle: 'Necesitás variedad, propósito y conexión con personas para rendir bien. La rutina sin sentido te drena el entusiasmo.',
