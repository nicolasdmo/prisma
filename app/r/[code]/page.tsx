...
export default function ResultPage({ params }: ResultPageProps) {
  ...
  // Flash completes after the color overlay exits
  useEffect(() => {
    const t = setTimeout(() => setFlashDone(true), 900);
    return () => clearTimeout(t);
  }, []);

  return (
    <>
      {/* ── Full-screen color flash on arrival ─────────────── */}
      <motion.div
